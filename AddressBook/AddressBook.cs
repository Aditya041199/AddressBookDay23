...
namespace AddressBookDay23
{
    public class AddressBook
    {
        ...
        public void EditContact()
        {
            ...
            {
                case 1:
                    Console.WriteLine("Enter the Modifed FirstName");
                    string FName = Console.ReadLine();
                    ContactArray[i].FirstName = FName;
                    break;
                case 2:
                    Console.WriteLine("Enter the Modifed LastName");
                    string LName = Console.ReadLine();
                    ContactArray[i].LastName = LName;
                    break;
                case 3:
                    Console.WriteLine("Enter the Modifed Address");
                    string Add = Console.ReadLine();
                    ContactArray[i].Address = Add;
                    break;
                case 4:
                    Console.WriteLine("Enter the Modifed City");
                    string city = Console.ReadLine();
                    ContactArray[i].City = city;
                    break;
                case 5:
                    Console.WriteLine("Enter the Modifed State");
                    string StateN = Console.ReadLine();
                    ContactArray[i].State = StateN;
                    break;
                case 6:
                    Console.WriteLine("Enter the Modifed Zip");
                    int ZipN = Convert.ToInt32(Console.ReadLine());
                    ContactArray[i].Zip = ZipN;
                    break;
                case 7:
                    Console.WriteLine("Enter the Modifed Email");
                    string MailID = Console.ReadLine();
                    ContactArray[i].Email = MailID;
                    break;
                case 8:
                    Console.WriteLine("Enter the Modifed PhoneNum");
